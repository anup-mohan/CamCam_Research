...
for dim in dimensions:
	...
	tp_infile = open(parent_folder + dim + "/" + "HoG_true_positives.csv",'r')
	fp_infile = open(parent_folder + dim + "/" + "HoG_false_positives.csv",'r')
	fn_infile = open(parent_folder + dim + "/" + "HoG_false_negatives.csv",'r')
...
for dim in legend:
	...
	for score in scores:
		...
		print "miss",score, fppi, missRate
